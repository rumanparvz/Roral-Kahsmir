...
@section('content')
            ...
            <div class="row foods-wrapper">
                <div class="col-lg-3 col-md-6">
                    <div class="single-food text-center">
                        <img src="{{asset('images/fontent')}}/icons/3.png" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-food orange text-center">
                        <img src="{{asset('images/fontent')}}/icons/f-2.png" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-food text-center">
                        <img src="{{asset('images/fontent')}}/icons/f-3.png" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-food orange text-center">
                        <img src="{{asset('images/fontent')}}/icons/f-4.png" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 col-5 d-flex align-items-stretch ">
                                <div class="about-gallery-5 text-center">
                                    <img src="{{asset('images/fontent')}}/gallery/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12  wow fadeInRight">
                    <div class="about-right">
                        <div class="about-r-shapes">
                            <span class="as-1"><img src="{{asset('images/fontent')}}/shapes/1.png" alt=""></span>
                        </div>
                        <h2>The Story about
                            Food khan, only for
                                    ...
                                    <div class="his-content">
                                        ...
                                        <div
                                            ...
                                            <div class="sig-img d-flex align-items-center"><img
                                                    src="{{asset('images/fontent')}}/icons/sig.png" alt="">
    ...
    <section class="delicious-area padding-top-120 padding-bottom-120">
        <div class="container">
            <div class="deli-shapes">
                <span class="ds-1"><img src="{{asset('images/fontent')}}/shapes/transparent1.png" alt=""></span>
                <span class="ds-2 item-animateOne"><img src="{{asset('images/fontent')}}/shapes/27.png" alt=""></span>
            </div>
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 d-none d-lg-block  wow fadeInRight">
                    <div class="delicious-right">
                        <img src="{{asset('images/fontent')}}/gallery/1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="team-area padding-bottom-110 padding-top-110 wow fadeInUp">
        <div class="team-area-shapes">
            <span class="ts-1"><img src="{{asset('images/fontent')}}/shapes/pizza-s1.png" alt=""></span>
            <span class="ts-2"><img src="{{asset('images/fontent')}}/shapes/brr.png" alt=""></span>
        </div>
        <div class="container">
            ...
            <div class="team-slider-active">
                <div class="single-team text-center">
                    <div class="s-t-img">
                        <img src="{{asset('images/fontent')}}/team/t1.png" alt="">
                    </div>
                    <div class="t-content">
                ...
                <div class="single-team text-center">
                    <div class="s-t-img">
                        <img src="{{asset('images/fontent')}}/team/t2.png" alt="">
                    </div>
                    <div class="t-content">
                        <h5>Malina Weissa</h5>
                        <p>It is a long established fact that a reader BBQ food Chicken.</p>
                ...
                <div class="single-team text-center">
                    <div class="s-t-img">
                        <img src="{{asset('images/fontent')}}/team/t3.png" alt="">
                    </div>
                    <div class="t-content">
                        <h5>Tonmoy Khan</h5>
                        <p>It is a long established fact that a reader BBQ food Chicken.</p>
                ...
                <div class="single-team text-center">
                    <div class="s-t-img">
                        <img src="{{asset('images/fontent')}}/team/t4.png" alt="">
                    </div>
                    <div class="t-content">
                        <h5>Mathja Semo</h5>
                        <p>It is a long established fact that a reader BBQ food Chicken.</p>
        ...
        <div class="container">
            ...
            <div class="blog-slider-active">
                <div class="single-blog">
                    <div class="blog-img">
                        <a href="blog-single.html"> <img src="{{asset('images/fontent')}}/blog/b-1.jpg" alt=""></a>
                        <div class="b-badge">
                ...
                <div class="single-blog">
                    <div class="blog-img">
                        <a href="blog-single.html"> <img src="{{asset('images/fontent')}}/blog/b-2.jpg" alt=""></a>
                        <div class="b-badge">
                            <span class="date"><a href="#">02</a></span><br>
                            <span class="month"><a href="#">dec</a></span>
                        </div>
                ...
                <div class="single-blog">
                    <div class="blog-img">
                        <a href="blog-single.html"> <img src="{{asset('images/fontent')}}/blog/b-3.jpg" alt=""></a>
                        <div class="b-badge">
                            <span class="date"><a href="#">02</a></span><br>
                            <span class="month"><a href="#">dec</a></span>
                        </div>
